    ...
    <div className="flex flex-col bg-secondary text-white">
      <div className="pc:flex tab:flex justify-between mobile:gap-4 items-start px-20 mobile:px-7 mobile:py-10">
        ...
        <div className="flex flex-col justify-start items-start w-40 mobile:mt-6 gap-2">
          ...
          <a href="mailto:help@speednet.com">help@speednet.com</a>
          <div className="flex gap-4 items-center mt-2">
            <a href="#" aria-label="Instagram"><FaInstagram className='text-[27px] mobile:text-[19px]' /></a>
            <a href="#" aria-label="X (Twitter)"><FaXTwitter className='text-[27px] mobile:text-[19px]' /></a>
            <a href="#" aria-label="Telegram"><FaTelegram className='text-[27px] mobile:text-[19px]' /></a>
            <a href="#" aria-label="TikTok"><FaTiktok className='text-[27px] mobile:text-[19px]' /></a>
          </div>
        </div>
