...
const getStatusBadge = (status) => {
  switch (status.toLowerCase()) {
    case "received":
      return <span className="bg-green-100 text-green-800 px-2 py-0.5 text-xs rounded">Received</span>;
    case "pending":
      return <span className="bg-yellow-100 text-yellow-800 px-2 py-0.5 text-xs rounded">Pending</span>;
    default:
      return <span className="bg-gray-100 text-gray-800 px-2 py-0.5 text-xs rounded">Unknown</span>;
  }
};
...
const SmsActivate = () => {
  ...
  return (
    <div className=" text-gray-300">
      ...
      {/* Analytics */}
      <div className="pc:flex tab:flex items-center justify-between gap-3 ">
        <div className="bg-blue-800/40 px-4 py-4 w-full  flex items-center gap-4 rounded-md border-b border-[#1e1d7c]">
        ...
        <div className="bg-teal-600/40 px-4 py-4 w-full  flex items-center gap-4 rounded-md border-b border-[#1c7e21]">
        ...
        <div className="bg-yellow-300/40 px-4 py-4 w-full flex items-center gap-4 rounded-md border-b border-[#ffe23b]">
      ...
      <div className="items-start mt-2 mb-3">
       <NavLink to="/user/get-number"> <Button size="sm" className="py-2 bg-primary-600">Get Number</Button></NavLink>
      </div>
<div className="w-full items-center flex gap-3">
  <section className="w-full">
      ...
      <div className="bg-gray-800 rounded-lg border border-gray-600 p-4 mb-6">
        ...
        {smsMessages.map((sms) => (
          <div key={sms.id} className="mb-4 p-3 border border-gray-700 rounded hover:bg-gray-700/50">
            ...
            {sms.status === "received" ? (
              <>
                <div className="bg-gray-700 p-2 rounded mb-2 text-sm">{sms.message}</div>
                <div className="flex justify-between items-center">
                  <span className="text-sm">
                    <strong>Code:</strong>{" "}
                    <code className="bg-blue-900 text-blue-300 px-2 py-1 rounded">{sms.code}</code>
                  </span>
                  <button
