  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="bg-yellow-100 w-full text-yellow-800 border-l-4 border-yellow-500 px-4 py-3 rounded-lg text-sm mobile:text-[13px] pc:text-base">
        <span className="font-medium">Important!</span> Customers are not eligible for a refund on any social media
        product unless it is reported as defective and returned within 24 hours of purchase.
      </div>
                    ...
                    <div>
                      <div className="flex flex-col pb-2">
                        ...
                        <div className="flex gap-2 items-center">
                          ...
                          <Button size="sm" className="text-gray-300 bg-slate-700 shadow-md py-1">
                            Chat Merchant
                          </Button>
                        </div>
                      </div>
