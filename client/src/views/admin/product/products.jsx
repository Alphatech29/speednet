...
import { PiShoppingCartSimpleFill, PiTrafficConeLight } from "react-icons/pi";
...
const TABS = [
  {
    label: "All Products",         icon: PiShoppingCartSimpleFill, component: AllProductTab,
    color: "bg-blue-100 text-blue-600",   dot: "bg-blue-500",   active: "border-blue-500",
  },
  {
    label: "Waiting for Approval", icon: PiTrafficConeLight,       component: UnderReviewingTab,
    color: "bg-amber-100 text-amber-600", dot: "bg-amber-500",  active: "border-amber-500",
  },
  {
    label: "Rejected",             icon: MdBlock,                  component: RejectedTab,
    color: "bg-red-100 text-red-600",     dot: "bg-red-500",    active: "border-red-500",
  },
];
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div>
        ...
        <p className="text-sm text-gray-400 mt-0.5">Manage and review merchant-submitted products</p>
      </div>
