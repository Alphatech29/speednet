...
const OrderDetails = ({ order, onClose }) => {
  ...
  return (
    <Modal show={show} onClose={onClose} popup size="lg">
      ...
      <Modal.Body className="bg-primary-50 text-secondary overflow-y-auto max-h-[80vh] px-4 pc:px-6 pb-4">
        {/* Order Info */}
        ...
        {order.isDarkshop && order.darkshop_content && (
          <div className="mt-4 shadow-md shadow-secondary rounded-md px-3 py-2">
            <p className="text-[15px] font-medium pb-2">Product Info:</p>
            <div className="text-sm text-secondary/50 space-y-2">
              <Button
                size="sm"
                color="light"
        ...
        {!order.isDarkshop && (
          <>
            ...
            <div className="mt-4 shadow-md shadow-secondary rounded-md px-3 py-2">
              ...
              <div className="text-sm text-secondary/50 space-y-1">
      ...
      <Modal.Footer className="justify-end bg-primary-50 px-4 pb-4">
