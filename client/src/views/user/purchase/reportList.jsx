...
const ReportList = () => {
  ...
  return (
    <div className="w-full">
      <h2 className="text-lg font-medium text-secondary mb-3">My Reports</h2>

      <div className="bg-primary-50 rounded-md">
        {reports.length === 0 ? (
          <div className="flex flex-col items-center justify-center min-h-[200px] text-secondary">
          ...
          <div className="overflow-x-auto">
            <Table hoverable className="bg-transparent text-xs tab:text-sm pc:text-base">
              <Table.Head className=" text-secondary bg-transparent">
              ...
              <Table.Body className="divide-y divide-primary-600">
                {reports.map((report, index) => (
                  <Table.Row key={report.id} className=" text-secondary">
